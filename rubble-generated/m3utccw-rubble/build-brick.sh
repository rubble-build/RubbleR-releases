...
pipeline_auth_relative='rubble-generated/m3utccw-rubble/pipeline-auth.enc'
...
open_auth_script_relative='rubble-generated/m3utccw-rubble/open-pipeline-auth.mjs'
...
"${rubble}" -q pull --rubble-home "${rubble_home}" --depth 1 --unpack -r default "${brick_file}"
