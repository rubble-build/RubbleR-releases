...
release_brick_files=(
  ...
  'store/pj/ol/brk-pjol6nye4q4w45kso64a5a3lgz7komnduridgu2u65i4kvvtrzqq-RubbleR.git.brick'

  'store/tw/dp/brk-twdpovgt7kde376fexippgdx5euczr52tvgjiwv4fy2cr3jxjpxq-rubble.src-patch.brick'

  'store/r2/3d/brk-r23dbnirt7kj7qt2ss753s5eiqsrract6pjehwfwh4saa3zi77na-rubble-web-assets.brick'

  'store/yi/2i/brk-yi2iy3psm5kmxj7v6d6kyyvpubt7kgd3obomk3fwywku2rqgc2gq-rubble.brick'
