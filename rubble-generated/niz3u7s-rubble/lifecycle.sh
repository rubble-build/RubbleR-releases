...
root_brick_relative='store/ni/z3/brk-niz3u7s37ltlvvoqqlcs4r7bbhp2prlm34bzeccnlxg3krzcahda-rubble.brick'
export RUBBLE_ROOT_BRICK="${lifecycle_dir}/${root_brick_relative}"
export RUBBLE_ROOT_ID='niz3u7s37ltlvvoqqlcs4r7bbhp2prlm34bzeccnlxg3krzcahda-rubble'
