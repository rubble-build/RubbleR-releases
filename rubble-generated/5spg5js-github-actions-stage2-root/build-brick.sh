...
if [[ -z "${RUBBLE_REUSE_VALIDATION_SECOND_RUN:-}" ]]; then
  log "starting second invocation to validate exact installed Rubble reuse"
  RUBBLE_REUSE_VALIDATION_SECOND_RUN=1 "$0" "${brick_file}"
fi
