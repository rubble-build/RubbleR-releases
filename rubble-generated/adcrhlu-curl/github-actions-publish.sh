...
root_name='curl'
pipeline_id='80eceebf-10b3-4915-827a-0497c6cdaa6f'
pipeline_branch="runs/${pipeline_id}"

pipeline_environment='rubble-pipeline-80eceebf-10b3-4915-827a-0497c6cdaa6f'
environment_created=0
cleanup_repository=''

workflow_path='.github/workflows/rubble.yml'
generated_root='rubble-generated/adcrhlu-curl'
managed_output_paths=(

  '.github/workflows/rubble.yml'

  'rubble-generated/adcrhlu-curl/build-brick.sh'

  'rubble-generated/adcrhlu-curl/cleanup-auth.sh'

  'rubble-generated/adcrhlu-curl/github-actions-publish.sh'

  'rubble-generated/adcrhlu-curl/open-pipeline-auth.mjs'

  'rubble-generated/adcrhlu-curl/pipeline-auth.enc'

  'rubble-generated/adcrhlu-curl/release-bundle.sh'

  'rubble-generated/adcrhlu-curl/release-inventory.txt'

  'rubble-generated/adcrhlu-curl/release-root.sh'

  'rubble-generated/adcrhlu-curl/store/5n/72/brk-5n72uhvu5cptapfmuhaql6u7gekif3s7rsavzqfspcxoyrwoybmq-curl-linux-x86_64-musl-8.18.0.tar.xz.brick'

  'rubble-generated/adcrhlu-curl/store/ad/cr/brk-adcrhlud4lao22xpeqdtkmm3cbdxrk4yn7hqqh4y2wguzsupqiqq-curl.brick'
